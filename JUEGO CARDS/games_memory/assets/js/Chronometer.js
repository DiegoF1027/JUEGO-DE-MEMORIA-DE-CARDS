...
class Chronometer {
  ...
  clearChronometer() {
    ...
    this.secondsAux = 0; // Reiniciar los segundos auxiliares a cero
    this.minutesAux = 0; // Reiniciar los minutos auxiliares a cero
  }
...
// Crear un objeto cronómetro
const chronometer = new Chronometer('chronometerId', 1000, 60000);

// Obtener los botones de nivel de dificultad
const buttons = document.querySelectorAll('.btn');

// Agregar un event listener a cada botón de nivel de dificultad
buttons.forEach(button => {
button.addEventListener('click', function() {
  // Iniciar el cronómetro al seleccionar un nivel de dificultad
  chronometer.clearChronometer();
